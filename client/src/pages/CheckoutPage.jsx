...
const CheckoutPage = () => {
    ...
    const processCheckout = async () => {
        ...
        try {
            // 1. Create Order
            const orderRes = await fetch('https://vend-n-learn.onrender.com/api/orders', {
                method: 'POST',
            ...
            // 2. Mark as Paid
            const payRes = await fetch(`https://vend-n-learn.onrender.com/api/orders/${order._id}/pay`, {
                method: 'PUT',
